...
::: callout-tip
## Learning Goals
Read and understand structure of functions in R in terms of inputs, arguments, return objects, and naming.
:::
 
## Function Structure

### Exercise: function structure

::: callout-note
## Objective
Note the structure of three functions that you are familiar with.
:::

Pick three functions of your choice and note their characteristics. (pairs)
...
### Exercise: thinking in functions

::: callout-note
## Objective
Think through the structure of a function.
:::
