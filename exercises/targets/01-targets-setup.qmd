...
::: callout-note
## Objective
Create the base of a usable workflow by making a _targets.R script.
:::
...
::: callout-note
## Objective
Load packages in a {targets} workflow using a designated packages script in the R/ directory.
:::
...
::: callout-note
## Objective
Source all functions in the R/ directory so that the {targets} workflow can run.
:::
...
::: callout-note
## Objective
Create a space in the _targets.R script to set workflow options.
:::
...
::: callout-note
## Objective
Add targets to your {targets} workflow.
:::
...
#### Bonus
- if you made a `plot_xy()` function in the previous section's bonus, add it to your pipeline
- add another target to read the other CSV file
- add another target to load the `palmerpenguins` dataset from {palmerpenguins}
- inspect the example workflow (`example-targets-workflow/_targets.R`) and add a new function